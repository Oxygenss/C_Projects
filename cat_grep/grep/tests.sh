...
"for parse.c parse.h Makefile FLAGS"
"for parse.c FLAGS"
"-e for -e ^int parse.c parse.h Makefile FLAGS"
"-e for -e ^int parse.c FLAGS"
"-e regex -e ^print parse.c FLAGS -f test_files/test_ptrn_grep.txt"
"-e while -e void parse.c Makefile FLAGS -f test_files/test_ptrn_grep.txt"
